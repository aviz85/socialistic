"""
Django settings for socialistic project.
...
WSGI_APPLICATION = 'socialistic.wsgi.application'
ASGI_APPLICATION = 'socialistic.asgi.application'
...
# In production, you should specify the allowed origins:
